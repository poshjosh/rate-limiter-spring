...
@Configuration
public class RateLimiterWebMvcConfiguration extends WebMvcConfigurationSupport {

    private final String controllerPackageName;

    public RateLimiterWebMvcConfiguration(@Value("${rate-limiter.controller-package:''}") String controllerPackageName) {
