...
public class LinkedMultiValueMap<K, V> implements MultiValueMap<K, V>, Serializable, Cloneable {
    ...
    public org.springframework.util.LinkedMultiValueMap<K, V> deepCopy() {
        org.springframework.util.LinkedMultiValueMap<K, V> copy = new org.springframework.util.LinkedMultiValueMap<>(this.targetMap.size());
     ...
     * @see #put(Object, List)
     * @see #putAll(Map)
     * @see org.springframework.util.LinkedMultiValueMap#LinkedMultiValueMap(Map)
     * @see #deepCopy()
     */
    @Override
    public org.springframework.util.LinkedMultiValueMap<K, V> clone() {
        return new org.springframework.util.LinkedMultiValueMap<>(this);
    }
