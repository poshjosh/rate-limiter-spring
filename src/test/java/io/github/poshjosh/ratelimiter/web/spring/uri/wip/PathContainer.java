 ...
 * into a sequence of {@link PathContainer.Separator} and {@link PathContainer.PathSegment} elements.
 *
 * <p>Each {@link PathContainer.PathSegment} exposes its content in decoded form and with path
...
public interface PathContainer {
    ...
    /**
     * The contained path elements, either {@link PathContainer.Separator} or {@link PathContainer.PathSegment}.
     */
    ...
    /**
     * Parse the path value into a sequence of {@code "/"} {@link PathContainer.Separator Separator}
     * and {@link PathContainer.PathSegment PathSegment} elements.
     * @param path the encoded, raw path value to parse
     * @return the parsed path
     */
    static PathContainer parsePath(String path) {
        return DefaultPathContainer.createFromUrlPath(path, PathContainer.Options.HTTP_PATH);
    }

    /**
     * Parse the path value into a sequence of {@link PathContainer.Separator Separator} and
     * {@link PathContainer.PathSegment PathSegment} elements.
     * @param path the encoded, raw path value to parse
     ...
     */
    interface Separator extends PathContainer.Element {
    }
     ...
     */
    interface PathSegment extends PathContainer.Element {
    ...
    class Options {
         ...
         */
        public final static PathContainer.Options HTTP_PATH = PathContainer.Options
                .create('/', true);
         ...
         */
        public final static PathContainer.Options MESSAGE_ROUTE = PathContainer.Options
                .create('.', false);
        ...
        /**
         * Create an {@link PathContainer.Options} instance with the given settings.
        ...
        public static PathContainer.Options create(char separator, boolean decodeAndParseSegments) {
            return new PathContainer.Options(separator, decodeAndParseSegments);
        }
    }
